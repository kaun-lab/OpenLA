...
class InitArduino:
    ...
    """
    def __init__(self, port='COM8', baudrate=25000, timeout=0.03):
...
class Arena():
    ...
    *Optionally* an occupancy ROI instance
    ...
    def __init__(self, arena_label, arena_id, input_frame, get_occupancy_roi=False, 
                 ...
                 write_video=True, debug_mode=False, fps_cap=30, use_arduino=True,
                 arduino_obj = None):
...
def start_fly_tracking(expt_dur = 900, led_freq = 5, led_pw=5, fps_cap = 30, 
                       ...
                       default_save_dir = "C:\\Users\\Mixologist\\Desktop\\Guillaume's Operant Data"):
    if use_arduino:
        try:
            arduino = InitArduino()
        except:
...
if __name__ == '__main__':    
    start_fly_tracking(expt_dur = 60, write_video=True, 
                       define_occupancy_roi=True, movement_assay=False, 
                       use_arduino=True, write_csv=True, num_arenas=4, debug_mode=False)
