...
class Arena():
    ...
    *Optionally* an occupancy ROI instance
    ...
    def __init__(self, arena_label, arena_id, input_frame, get_occupancy_roi=False, 
                 write_video=False, debug_mode=False, fps_cap=15, use_arduino=False,
                 arduino_obj = None):
...
#%%
def start_fly_tracking(expt_dur = 900, led_freq = 5, led_pw=5, fps_cap = 5, 
                       ...
                       default_save_dir = "D:\Operant Conditioning Data G"):
    if use_arduino:
        try:
            arduino = InitArduino()
        except:
